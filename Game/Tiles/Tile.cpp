...
namespace GameDev2D
{
    ...
    void Tile::AddRandomPickup()
    {
        Random random;
        random.RandomizeSeed();

        switch (random.RandomRange(0, PickupTypeCount))
        {
        case PickupTypeHeart:
            this->AddPickup(new HeartPickup());
            break;

        case PickupTypeGreenRupee:
            this->AddPickup(new GreenRupeePickup());
            break;

        case PickupTypeBlueRupee:
            this->AddPickup(new BlueRupeePickup());
            break;

        case PickupTypeBomb:
            this->AddPickup(new BombPickup());
            break;

        case PickupTypeHeartPiece:
            this->AddPickup(new HeartPiecePickup());
            break;
    ...
    void Tile::SetIsADestination(bool aIsDestination)
    {
        m_IsDestination = aIsDestination;
    }

    bool Tile::GetIsADestination()
    {
